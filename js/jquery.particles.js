...
(function (global, factory) {
    ...
    function moveParticles(particles, isMove, musicRandom, speed, musicStrengh) {
		mus = musicStrengh;
        if (isMove && musicRandom) {
    ...
    function updateParticlesArray(isMove, musicRandom, isBounce, moveOutMode, musicStrengh) {
        for (var i = 0; i < particlesArray.length; i++) {
            moveParticles(particlesArray[i], isMove, musicRandom, particlesArray[i].speed, musicStrengh);
    ...
    function runParticlesTimer(that) {
        timer = requestAnimationFrame(function animal() {
            updateParticlesArray(that.isMove, that.musicRandom, that.isBounce, that.moveOutMode, that.musicStrengh);
    ...
    var Particles = function (el, options) {
        ...
        this.musicRandom = options.musicRandom;
    ...
    Particles.prototype = {
		...
		particlesSnow: function () {
			img.src = 'Default Content/map/snow.png'
		},
        ...
        particlesImage: function (imgSrc,blnDefault) {
            if (imgSrc) {
                ...
                img.src = 'Default Content/map/1.png';
            }
            img.onload = function () {
